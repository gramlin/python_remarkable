...
#set page(
  ...
  header: [
    #align(right)[
      #text(size: 9.5pt, fill: rgb(102, 102, 102))[
...
#set text(font: "DejaVu Sans Mono", size: 10.8pt)
...
#h1[Veckoplanering]
#v(2pt)
#text(size: 10pt, fill: muted)[Fokus, möten och anteckningar på ett ställe.]
#v(10pt)
...
#block(
  ...
  #stack(spacing: 6pt)[
    #text(size: 10pt, weight: 750, fill: ink)[Veckans fokus]
    #divider()
    #notes_lines(3)
  ]
]
